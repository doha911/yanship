...
class DriverForm2 extends StatefulWidget {
  final DriverModel customer;

  const DriverForm2({Key? key, required this.customer}) : super(key: key);

  @override
  State<DriverForm2> createState() => _CustomerForm2State();
}

class _CustomerForm2State extends State<DriverForm2> {
